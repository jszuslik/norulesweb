...
function nrw_load_scripts() {
    ...
    wp_enqueue_script('nrw_scrollbar_lib_scripts', NRW_LIBS_URI . 'scrollbar/jquery.scrollbar.min.js', array(), false, true);
    wp_enqueue_script('nrw_magnific_lib_scripts', NRW_LIBS_URI . 'magnific-popup/jquery.magnific-popup.min.js', array(), false, true);
    wp_enqueue_script('nrw_swiper_lib_scripts', NRW_LIBS_URI . 'swiper/swiper.jquery.min.js', array(), false, true);
    wp_enqueue_script('nrw_masonry_lib_scripts', NRW_LIBS_URI . 'masonry/jquery.masonry.pkgd.min.js', array(), false, true);
    wp_enqueue_script('nrw_image_loaded_scripts', NRW_LIBS_URI . 'masonry/imagesloaded.pkgd.min.js', array(), false, true);
    wp_enqueue_script('nrw_equal_height_scripts', NRW_LIBS_URI . 'jquery.equal-height.min.js', array(), false, true);
    wp_enqueue_script('nrw_waypoint_lib_scripts', NRW_LIBS_URI . 'waypoint.min.js', array(), false, true);
    wp_enqueue_script('nrw_counterup_lib_scripts', NRW_LIBS_URI . 'counterup.min.js', array(), false, true);
    wp_enqueue_script('nrw_cuberportfolio_lib_scripts', NRW_LIBS_URI . 'cubeportfolio/js/jquery.cubeportfolio.min.js', array(), false, true);
    wp_enqueue_script('nrw_parallax_lib_scripts', NRW_LIBS_URI . 'jquery.parallax.min.js', array(), false, true);
    // wp_enqueue_script('nrw_googlemap_lib_scripts', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBsXUGTFS09pLVdsYEE9YrO2y4IAncAO2U', array(), false, true);
    wp_enqueue_script('nrw_wow_lib_scripts', NRW_LIBS_URI . 'jquery.wow.min.js', array(), false, true);
    wp_enqueue_script('nrw_skrollr_lib_scripts', NRW_LIBS_URI . 'skrollr/skrollr.min.js', array(), false, true);
    ...
    wp_enqueue_script('nrw_mas_scripts', NRW_ASSETS_URI . 'js/components/masonry.min.js', array(), false, true);
    wp_enqueue_script('nrw_eq_scripts', NRW_ASSETS_URI . 'js/components/equal-height.min.js', array(), false, true);
