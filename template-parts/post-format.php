    ...
    <?php if ( $images ) : ?>
        <div class="post-format post-gallery slider">
            <?php foreach ( $images as $image_id ) : ?>
                <?php
                $image_url = nrw_resize_image( $image_id, null, 1170, 780, true, true );
...
<?php else: ?>
    <?php if ( has_post_thumbnail() ) : ?>
        ...
        $image_url = nrw_resize_image( $thumb_id, null, 1170, 780, true, true );
        $image_url = $image_url['url'];
        ?>
        <div class="post-format post-standard">
            ...
            <?php else : ?>
                <?php if ( !get_theme_mod('nrw_display_featured_image_single') ) : ?>
