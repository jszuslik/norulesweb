...
?>
<!--========== PROMO BLOCK ==========-->
<div class="s-promo-block-v1 g-bg-color--dark-light g-fullheight--md">
        ...
        <div class="row g-hor-centered-row--md g-margin-t-30--xs g-margin-t-20--sm">
            <div class="col-lg-6 col-sm-6 g-hor-centered-row__col g-text-center--xs g-text-left--md g-margin-b-60--xs g-margin-b-0--md">
                <div class="s-promo-block-v1__square-effect g-margin-b-60--xs">
                    <h1 class="g-font-size-32--xs g-font-size-45--sm g-font-size-50--lg g-color--white">Reliable Website Design Near Milwaukee, WI</h1>
                    <p class="g-font-size-20--xs g-font-size-26--md g-color--white g-margin-b-0--xs">Our process is simple. <b>YOU</b> know your business better than anyone else. We turn <b>YOUR</b> expertise and <b>YOUR</b> ideas into an inv</p>
                </div>
